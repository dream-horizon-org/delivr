...
import type { ChannelConfigModelType } from './slack-channel-config.sequelize.model';
...
export class ChannelConfigRepository {
  private model: ChannelConfigModelType;

  constructor(model: ChannelConfigModelType) {
    this.model = model;
  }
   ...
   */
  private toPlainObject = (instance: InstanceType<ChannelConfigModelType>): TenantCommChannel => {
