...
export const createSlackIntegrationModel = (sequelize: Sequelize) => {
  class SlackIntegrationModel
...
export type SlackIntegrationModelType = ReturnType<typeof createSlackIntegrationModel>;
