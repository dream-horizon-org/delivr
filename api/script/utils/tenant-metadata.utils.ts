 ...
 */
export function transformScmIntegrationsForConfig(scmIntegrations: any[]): any[] {
  return scmIntegrations.map((i: any) => ({
    id: i.id,
    ...
    connectedBy: i.createdByAccountId || SYSTEM_USER,
  }));
}
 ...
 */
export function transformSlackIntegrationForConfig(slackIntegration: any | null): any[] {
  if (!slackIntegration) {
    return [];
  }
 ...
 */
export function transformCicdIntegrationsForConfig(cicdIntegrations: any[]): any[] {
  return cicdIntegrations.map((i: any) => ({
    id: i.id,
 ...
 */
export function transformTestManagementIntegrationsForConfig(testManagementIntegrations: any[]): any[] {
  return testManagementIntegrations.map((i: any) => ({
    id: i.id,
    providerId: i.providerType.toLowerCase(),
    name: i.name,
 ...
 */
export function transformProjectManagementIntegrationsForConfig(projectManagementIntegrations: any[]): any[] {
  return projectManagementIntegrations.map((i: any) => ({
    id: i.id,
    providerId: i.providerType.toLowerCase(),
    name: i.name,
    status: i.isEnabled 
 ...
 */
export function transformAppDistributionIntegrationsForConfig(storeIntegrations: any[]): any[] {
  return storeIntegrations.map((i: any) => ({
    id: i.id,
...
export function buildTenantConfig(
  ...
  return {
    connectedIntegrations: {
      SOURCE_CONTROL: transformScmIntegrationsForConfig(scmIntegrations),
      COMMUNICATION: transformSlackIntegrationForConfig(slackIntegration),
      CI_CD: transformCicdIntegrationsForConfig(cicdIntegrations),
      TEST_MANAGEMENT: transformTestManagementIntegrationsForConfig(testManagementIntegrations),
      PROJECT_MANAGEMENT: transformProjectManagementIntegrationsForConfig(projectManagementIntegrations),
      APP_DISTRIBUTION: transformAppDistributionIntegrationsForConfig(storeIntegrations),
    },
