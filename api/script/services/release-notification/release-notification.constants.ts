...
export const NOTIFICATION_TYPE_TO_TASK: Record<NotificationType, Task> = {
  ...
  [NotificationType.PRE_DISTRIBUTION_STAGE_APPROVAL_REQUEST]: Task.PRE_DISTRIBUTION_STAGE_APPROVAL_REQUEST,
  [NotificationType.TARGET_DATE_CHANGED]: Task.TARGET_DATE_CHANGED,
  [NotificationType.IOS_APPSTORE_BUILD_SUBMITTED]: Task.IOS_APPSTORE_BUILD_SUBMITTED,
  [NotificationType.ANDROID_PLAYSTORE_BUILD_SUBMITTED]: Task.ANDROID_PLAYSTORE_BUILD_SUBMITTED,
  [NotificationType.IOS_APPSTORE_LIVE]: Task.IOS_APPSTORE_LIVE,
  [NotificationType.ANDROID_PLAYSTORE_LIVE]: Task.ANDROID_PLAYSTORE_LIVE,
  [NotificationType.ANDROID_WEB_LIVE]: Task.ANDROID_WEB_LIVE,
  ...
  [NotificationType.IOS_APPSTORE_BUILD_RESUBMITTED]: Task.IOS_APPSTORE_BUILD_RESUBMITTED,
  [NotificationType.ANDROID_PLAYSTORE_BUILD_RESUBMITTED]: Task.ANDROID_PLAYSTORE_BUILD_RESUBMITTED,
  [NotificationType.IOS_APPSTORE_BUILD_REJECTED]: Task.IOS_APPSTORE_BUILD_REJECTED,
  [NotificationType.IOS_APPSTORE_BUILD_CANCELLED]: Task.IOS_APPSTORE_BUILD_CANCELLED,
  [NotificationType.ANDROID_PLAYSTORE_USER_ACTION_PENDING]: Task.ANDROID_PLAYSTORE_USER_ACTION_PENDING,
  [NotificationType.ANDROID_PLAYSTORE_SUSPENDED]: Task.ANDROID_PLAYSTORE_SUSPENDED,
};
