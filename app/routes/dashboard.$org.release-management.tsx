...
export const loader = authenticateLoaderRequest(async ({ params, user }) => {
  ...
  // Fetch all releases for analytics
...
export default function ReleaseDashboardPage() {
  ...
  const { org, setupComplete, analytics, recentReleases, adoptionChartData } = data as any;
  
  // If setup not complete, show setup prompt
  if (!setupComplete) {
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
        <div className="bg-white shadow rounded-lg p-8 max-w-md w-full text-center">
          ...
          <h2 className="text-xl font-bold text-gray-900 mb-2">
            Complete Release Management Setup
          </h2>
          <p className="text-gray-600 mb-6">
            Before you can view your release dashboard, you need to complete the initial setup.
          </p>
          <Link
            to={`/dashboard/${org}/releases/setup`}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="bg-white shadow rounded-lg p-6">
            ...
            <div className="space-y-3">
              ...
              <Link
                to={`/dashboard/${org}/releases?tab=active`}
                className="block w-full px-4 py-2 border border-gray-300 rounded-md text-sm font-medium text-gray-700 hover:bg-gray-50 text-center"
              >
