...
moveAssets();
run('yarn code-push-standalone release testOrg/testApp .dota-testing/.codepush 1.0.0 -d Production -r 100 --description "Testing new arch" -p true -c \'brotli\'', 'Creating codepush patch release');
